-- Add stable player_id support for stats derived from events

-- 1. Add player_id to player_stats (nullable for legacy rows)
...
-- 3. Update hand-level stats view to include player_id
...
-- 4. Aggregate stats grouped by player_id (fallback to player_name if null)
...
-- 5. Update refresh function to upsert by player_id when available
